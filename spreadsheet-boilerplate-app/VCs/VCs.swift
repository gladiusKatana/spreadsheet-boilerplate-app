...
var topVC = CollectionVC(.initial, populateStockCellData: false, backgroundColor: UIColor.clear, alternatingColors: false,
...
var incomeAndExpensesVC = CollectionVC(.firstVCType, populateStockCellData: true, backgroundColor: globalWindow.backgroundColor!, alternatingColors: false,
